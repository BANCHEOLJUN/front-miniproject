    ...
    xhr.onreadystatechange = () => {
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            for (index = 0; index < 10; index++) {
                ...
                row_body_data_2.innerHTML = `<img src=\"${parsedResult.items[index].image}\"></img>`;
                ...
                row_body_data_4.innerHTML = `<a href=\"${parsedResult.items[index].link}\">상세 보기</a>`;
